...
*(Administrator rights, `uv`, and PowerShell scripts are not required for the*
*course setup itself.)*


## Download and extract course package 

Extract the complete course package into a writable local folder to create
your project directory (e.g., `.../CATE/dgt-summer-school-2026/`). 
...
Alternatively, from PowerShell or Command Prompt in the project directory*note*,
run:
